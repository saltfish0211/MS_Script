...
var EventConfig = BossEventConfigs.森蘭丸;
...
function setup(eim, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("BossRanmaru_NORMAL");
	...
	eim.getMapFactoryMap(807300120).killAllMonsters(false);
	map.resetFully();
...
function changedMap(eim, player, mapid) {
    if (mapid != 807300210 && mapid != 807300120) {
