...
var EventConfig = BossEventConfigs.戴斯克;
...
function setup(eim, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("BossDusk_NORMAL");
    var map = eim.setInstanceMap(450009400); //設置活動腳本的地圖
...
function scheduledTimeout(eim) {
    eim.disposeIfPlayerBelow(100, 450009301);
    eim.dispose();
    em.setProperty("state", "0");
    em.setProperty("leader", "true");
}
