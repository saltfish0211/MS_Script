...
var itemList = Array(
Array(1112793, 20),
Array(1022148, 28),//  這個是眼飾的 
Array(1012319, 18), // 這個是臉飾的
Array(1112918, 18, 7),
Array(2431938, 198),
//Array(2070019, 20),
Array(1132246, 128),
...
Array(1122125, 268),//  - 
Array(1122126, 268),//  -
Array(1102471, 80), // 赫裡希安精銳劍士披風 // (無描述)
Array(1102472, 80), // 赫裡希安精銳法師披風 // (無描述)
Array(1102473, 80), // 赫裡希安精銳弓箭手披風 // (無描述)
Array(1102474, 80), // 赫裡希安精銳盜賊披風 // (無描述)
Array(1102475, 80), // 赫裡希安精銳海盜披風 // (無描述)
Array(1072732, 80), // 赫裡希安精銳劍士靴 // (無描述)
Array(1072733, 80), // 赫裡希安精銳法師靴 // (無描述)
Array(1072734, 80), // 赫裡希安精銳弓箭手靴 // (無描述)
Array(1072735, 80), // 赫裡希安精銳盜賊靴 // (無描述)
Array(1072736, 80), // 赫裡希安精銳海盜靴 // (無描述)
Array(1132164, 80), // 赫裡希安精銳劍士腰帶 // (無描述)
Array(1132165, 80), // 赫裡希安精銳法師腰帶 // (無描述)
Array(1132166, 80), // 赫裡希安精銳弓箭手腰帶 // (無描述)
Array(1132167, 80), // 赫裡希安精銳盜賊腰帶 // (無描述)
Array(1132168, 80), // 赫裡希安精銳海盜腰帶 // (無描述)
/*
